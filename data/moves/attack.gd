...
func _get_valid_targets(targets: Array[Node], battle_unit_owner: CreatureBattleUnit) -> Array[Node]:
...
func _handle_critical_hit(battle_unit_owner: CreatureBattleUnit) -> void:
